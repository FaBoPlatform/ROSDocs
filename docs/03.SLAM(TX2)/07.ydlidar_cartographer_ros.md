...
cp ~/catkin_ws/install_isolated/share/cartographer_ros/configuration_files/backpack_2d.lua \
        ~/catkin_ws/install_isolated/share/cartographer_ros/configuration_files/online_ydlidar_2d_slam.lua
```
...
+  <arg name="configuration_basenames" default="offline_ydlidar_2d_slam.lua"/>
...
+          -configuration_basename online_ydlidar_2d_slam.lua"
       output="screen">
     <remap from="echoes" to="horizontal_laser_2d" />
   </node>
```
...
+include "online_ydlidar_2d_slam.lua"
...
## online_ydlidar_2d_slam.lua
online SLAMの時に利用します。<br>
```
vi ~/catkin_ws/install_isolated/share/cartographer_ros/configuration_files/online_ydlidar_2d_slam.lua
```
```
...
+++ /home/ubuntu/catkin_ws/install_isolated/share/cartographer_ros/configuration_files/online_ydlidar_2d_slam.lua	2019-04-23 14:00:17.750949205 +0900
@@ -19,8 +19,8 @@
